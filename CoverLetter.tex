...
%
\def\Who{Slimane Dridi} % Your name
\def\What{, PhD} % Your title
\def\Where{Department of Biology} % Your department/institution
\def\Address{433 south University Avenue} % Your address
\def\CityZip{Philadelphia, PA, 19104} % Your city, zip code, country, etc
\def\EmailO{E-mail: slimane.dridi@gmail.com} % Your email address

\def\TEL{Phone: +1 267 244-3826} % Your phone number
\def\URL{URL: \url{https://www.researchgate.net/profile/Slimane_Dridi}} % Your URL
...
\address{
\includegraphics[width=1.2in]{logoUPenn.eps} % Include the logo of your institution
...
\signature{} % The signature is a combination of your name and title
